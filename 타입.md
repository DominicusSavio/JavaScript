...
<p>값에 해당하는 타입은 하나이고 변하지 않는다. 예를 들면 30에 해당하는 타입은 오직 Number이고, "30"에 해당하는 타입은 오직 String이다.</p>
<p>JavaScript는 변수에 타입 강제를 하지 않는다. 따라서 변수에 해당하는 타입은 없고, 언제든지 무엇이든지 값을 할당할 수 있다. 예를 들면 변수에 처음으로 30을 할당하고 나중에 "30"을 할당할 수 있다.</p>
<pre><code>
var value = 30;
